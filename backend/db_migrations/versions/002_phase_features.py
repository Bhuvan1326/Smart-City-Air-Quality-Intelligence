...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_satellite_observations_city"), "satellite_observations", ["city"], unique=False)
    op.create_index(op.f("ix_satellite_observations_observed_at"), "satellite_observations", ["observed_at"], unique=False)
    op.create_index(op.f("ix_satellite_observations_ward_id"), "satellite_observations", ["ward_id"], unique=False)
    ...
    op.create_index(op.f("ix_drone_flight_plans_city"), "drone_flight_plans", ["city"], unique=False)
    op.create_index(op.f("ix_drone_flight_plans_hotspot_id"), "drone_flight_plans", ["hotspot_id"], unique=False)
    op.create_index(op.f("ix_drone_flight_plans_ward_id"), "drone_flight_plans", ["ward_id"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column("contributing_factors", postgresql.ARRAY(sa.String(length=100)), nullable=True),
    ...
    op.create_index(op.f("ix_sensor_health_assessments_assessed_at"), "sensor_health_assessments", ["assessed_at"], unique=False)
    op.create_index(op.f("ix_sensor_health_assessments_maintenance_priority"), "sensor_health_assessments", ["maintenance_priority"], unique=False)
    op.create_index(op.f("ix_sensor_health_assessments_station_id"), "sensor_health_assessments", ["station_id"], unique=False)
