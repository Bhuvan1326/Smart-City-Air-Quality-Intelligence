...
def test_low_pm10_and_valid_permit_gives_low_risk():
    result = assess_construction_dust_risk(
        source_name="Wakad Metro Construction", source_type="construction", ward_id="W06",
        permit_status="valid", violation_count=0,
        nearest_station_name="Wakad Station", nearest_station_distance_km=0.8, pm10=40,
    )
...
def test_elevated_pm10_flags_as_supporting_observation():
    result = assess_construction_dust_risk(
        source_name="Site A", source_type="construction", ward_id="W06",
        permit_status="valid", violation_count=0,
        nearest_station_name="Station A", nearest_station_distance_km=1.0, pm10=180,
    )
...
def test_never_claims_confirmed_source():
    result = assess_construction_dust_risk(
        source_name="Site B", source_type="construction", ward_id="W06",
        permit_status="none", violation_count=5,
        nearest_station_name="Station B", nearest_station_distance_km=0.5, pm10=200,
    )
...
def test_multiple_weak_signals_escalate_moderate_to_high():
    result = assess_construction_dust_risk(
        source_name="Site C", source_type="construction", ward_id="W06",
        permit_status="expired", violation_count=2,
        nearest_station_name="Station C", nearest_station_distance_km=1.0, pm10=90,  # moderate band
...
def test_no_pm10_data_does_not_crash_or_fabricate():
    result = assess_construction_dust_risk(
        source_name="Site D", source_type="dust", ward_id=None,
        permit_status="valid", violation_count=0,
        nearest_station_name=None, nearest_station_distance_km=None, pm10=None,
    )
...
def test_far_station_flagged_as_caveat():
    result = assess_construction_dust_risk(
        source_name="Site E", source_type="construction", ward_id="W06",
        permit_status="valid", violation_count=0,
        nearest_station_name="Far Station", nearest_station_distance_km=5.5, pm10=60,
    )
