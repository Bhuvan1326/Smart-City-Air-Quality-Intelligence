...
from app.api.v1.endpoints.alerts import (alerts_router, attribution_router,
                                         mitigation_router, thresholds_router)
...
from app.api.v1.endpoints.construction_dust import \
    router as construction_dust_router
...
from app.api.v1.endpoints.model_performance import \
...
from app.api.v1.endpoints.waste_circularity import \
    router as waste_circularity_router
